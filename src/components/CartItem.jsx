...
import { addItem, removeCartItem, removeItem } from '../redux/reducer/cartReducer';
const CartItem = (props) => {

   const dispatch = useDispatch()

   const removeObjItems = () => {
      console.log('adwd');
   ...
   const plus = () => {
      ...
      dispatch(addItem(props.cartID))
   }
   const minus = () => {
      console.log('wdw');

      dispatch(removeItem(props.cartID))
   }
   ...
   return (
      <div className="cart__item">
         ...
         <div onClick={removeObjItems} className="cart__item-remove">
