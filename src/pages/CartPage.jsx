...
const CartPage = () => {
 ...
 Корзина</h2>
                        <div className="cart__clear">
                           ...
                           <button onClick={cartEmptyHandler}>Очистить корзину</button>
                        </div>
                     </div>
                     <div className="content__items-cart">
                        ...
                        {addItems
                           && addItems.map(i => {
                              return <CartItem key={uuid()} {...i} cartID={`${i.name}__${i.type}__${i.edition}`} objCount={cart[`${i.name}__${i.type}__${i.edition}`].items.length} objPrice={cart[`${i.name}__${i.type}__${i.edition}`].totalObjPrice} />
                           })
                        }
